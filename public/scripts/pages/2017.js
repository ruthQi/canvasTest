...
function() {
   ...
   document.addEventListener("touchmove", i, !1), document.addEventListener("touchstart", i, !1), /micromessenger/.test(navigator.userAgent.toLocaleLowerCase()) && NE(".share").hide(), t.prototype.initCanvas = function() {}, t.prototype.preImg = function(i) {
      function t() {
         e++, e == s.length && a()
      }
      for (var e = 0, a = function() {}, s = i, n = 0; n < s.length; n++) {
         var g = new Image;
      ...
      for (var t = 0, e = this, a = function() {}, s = this.imgList, n = 0; n < s.length; n++) this.imgList[n].image = new Image, this.imgList[n].image.src = s[n].link, this.imgList[n].image.i = n, this.imgList[n].image.name = n, this.imgList[n].image.className = "item", this.imgList[n].image.onload = function() {
      ...
      if (this.index + 1 != this.imgList.length) {
         if (this.radio < this.imgList[this.index + 1].areaW / this.imgList[this.index + 1].imgW) if (this.willPause) this.radio = this.imgList[this.index + 1].areaW / this.imgList[this.index + 1].imgW, cancelAnimationFrame(this.timer), NE(".gif").css("opacity", "1"), NE("#start").show();
         else if (console.log(this.radio), this.index++, this.radio = 1, !this.imgList[this.index + 1]) return void this.showend();
